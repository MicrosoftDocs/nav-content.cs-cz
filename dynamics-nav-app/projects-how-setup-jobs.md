...
**Poznámka**: Zaškrtávací políčko **Použít propojení spotřeby** je poměrně složité a proto je vysvětleno v následující části.
...
1. V pravém horním rohu zvolte ikonu **Vyhledat stránku nebo sestavu**, zadejte **Projekty** a poté zvolte související odkaz.  
